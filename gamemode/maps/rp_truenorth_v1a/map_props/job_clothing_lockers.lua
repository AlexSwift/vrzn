...
MapProp.m_tblLockers = {
	...
	{ pos = Vector(13144.646484375, 11146.1484375, 43.8568), ang = Angle(0, 90, 0), id = "JOB_FIREFIGHTER" }, --Fire
	{ pos = Vector(1628.70, 3566.47, 42.27), ang = Angle(0, -90, 0), id = "JOB_POLICE" }, --Police
}
