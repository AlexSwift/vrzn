...
GM.PlayerDamage.m_tblLimbs = {
	...
	[HITGROUP_LEFTARM] = { Name = "Chest", MaxHealth = 30 },
	[HITGROUP_RIGHTARM] = { Name = "Chest", MaxHealth = 30 },
	[HITGROUP_LEFTLEG] = { Name = "Legs", MaxHealth = 30 },
	[HITGROUP_RIGHTLEG] = { Name = "Legs", MaxHealth = 30 },
}
