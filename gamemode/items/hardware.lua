...
local Item = {}
Item.Name = "ASCI USB Stick"
Item.Desc = "A low-end Bitcoin miner."
Item.Model = "models/nicksmodels/asic_miner.mdl"
Item.Weight = 34
Item.Volume = 28
Item.HealthOverride = 2500
Item.CanDrop = true
Item.CollidesWithCars = true
Item.DropClass = "fbm_asic"
Item.LimitID = "fbm_asic"

GM.Inv:RegisterItem(Item)
GM.Inv:RegisterItemLimit(Item.LimitID, 25)

local Item = {}
Item.Name = "Extention Lead"
Item.Desc = "Plug Into For More Space"
Item.Model = "models/livinrp/plug_extension.mdl"
Item.Weight = 34
Item.Volume = 28
Item.HealthOverride = 2500
Item.CanDrop = true
Item.CollidesWithCars = true
Item.DropClass = "fbm_extention"
Item.LimitID = "fbm_extention"
...
local Item = {}
Item.Name = "USB Hub"
Item.Desc = "A Hub for miners"
Item.Model = "models/bitminer/usb_hub.mdl"
Item.Weight = 34
Item.Volume = 28
Item.HealthOverride = 2500
Item.CanDrop = true
Item.CollidesWithCars = true
Item.DropClass = "fbm_plug"
Item.LimitID = "fbm_plug"

GM.Inv:RegisterItem(Item)
GM.Inv:RegisterItemLimit(Item.LimitID, 3)

local Item = {}
Item.Name = "Bitcoin Stock"
Item.Desc = "A TV To View Bitcoin Prices"
...
Item.CanDrop = true
Item.CollidesWithCars = true
Item.DropClass = "fbm_monitor"
Item.LimitID = "fbm_monitor"

GM.Inv:RegisterItem(Item)
GM.Inv:RegisterItemLimit(Item.LimitID, 2)

local Item = {}
Item.Name = "Bitminer Plug"
Item.Desc = "A bitminer Plug."
Item.Model = "models/livinrp/plug_main.mdl"
Item.Weight = 34
Item.Volume = 28
Item.HealthOverride = 2500
Item.CanDrop = true
...
Item.Name = "Bitminer A1"
Item.Desc = "A Bitcoin Miner."
Item.Model = "models/livinrp/catminer_s9.mdl"
Item.Weight = 34
Item.Volume = 28
Item.HealthOverride = 2500
Item.CanDrop = true
Item.CollidesWithCars = true
Item.DropClass = "fbm_miner"
Item.LimitID = "fbm_miner"

GM.Inv:RegisterItem(Item)
GM.Inv:RegisterItemLimit(Item.LimitID, 40)