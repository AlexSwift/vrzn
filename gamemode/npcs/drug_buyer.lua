...
NPCMeta.ItemsForSale = {
	...
	["Cannabis Seeds (Low Quality)"] = 50,

	["Cannabis Seeds (Medium Quality)"] = 100,

	["Cannabis Seeds (High Quality)"] = 145,
...
NPCMeta.ItemsCanBuy = {
	...
	["Cannabis (Low Quality)"] = 80,

	["Cannabis (Medium Quality)"] = 225,

	["Cannabis (High Quality)"] = 400,

	["Moonshine"] = 50,

	["Methamphetamine (Low Quality)"] = 150,

	["Methamphetamine (Medium Quality)"] = 500,

	["Methamphetamine (High Quality)"] = 650,
}
...
elseif CLIENT then
	...
	NPCMeta.RandomGreetings = {
		...
		"I've got the best stuff around! Speak to Christopher Steele for Guns",
