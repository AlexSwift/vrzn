...
elseif CLIENT then
	...
	function NPCMeta:StartDialog()
		...
		GAMEMODE.Dialog:AddOption( "Quero ver o meu cofre..", function()
			GAMEMODE.Net:SendNPCDialogEvent( "bank_open_menu" )
			GAMEMODE.Dialog:HideDialog()
		end )
		GAMEMODE.Dialog:AddOption( "Quero ver os achados e perdidos.", function()
			GAMEMODE.Net:SendNPCDialogEvent( "bank_open_lostandfound_menu" )
			GAMEMODE.Dialog:HideDialog()
		end )
		GAMEMODE.Dialog:AddOption( "Vim pagar contas.", function()
			GAMEMODE.Net:SendNPCDialogEvent( "bank_open_bills_menu" )
			GAMEMODE.Dialog:HideDialog()
		end )
		GAMEMODE.Dialog:AddOption( "Deixa pra lá.", function()
