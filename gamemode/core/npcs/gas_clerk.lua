...
function NPCMeta:StartRobbing( pPlayer )
	GAMEMODE.StoreRobbery:PlayerRobShop( pPlayer )
end
...
if SERVER then
	...
	function NPCMeta:RegisterDialogEvents()
	    GM.Dialog:RegisterDialogEvent( "start_robbing_gas_clerk", self.StartRobbing, self )
	end
...
elseif CLIENT then
	...
	function NPCMeta:StartDialog()
		...
		GAMEMODE.Dialog:AddOption( "Hands Up, Head Down!", function()
			...
			GAMEMODE.Net:SendNPCDialogEvent( "start_robbing_gas_clerk" )
