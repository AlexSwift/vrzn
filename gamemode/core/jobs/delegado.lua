...
local Job = {}
Job.ID = 21
Job.Enum = "JOB_DELEGADO"
Job.Receives911Messages = true
Job.TeamColor = Color( 255, 0, 0, 255 )
Job.Name = "Polícia"
-- Job.WhitelistName = "police"
Job.Cat = "Agentes da lei"
Job.Text =[[Seja o comandante do departamento policial da cidade, e traga segurança a todos
	OBJETIVOS:
	...
	x Cuidar da parte administrativa da polícia
	x Organizar as investigações para a Polícia Civil
	x Agir em campo apenas quando for EXTREMAMENTE necessário
 
	REGRAS:
	x Multa no valor máximo de: R$1.000
	x Deve obedecer ordens do Prefeito
