...
GM.Config.DrivingTestQuestions_Answers = {
	...
	{ Question = "You encounter a police road block and the officer tells you to turn around, do you", Options = { ["Ignore the officer and continue driving"] = true, ["Just join defcon you dumb cunt."] = true, ["Carefully turn around and drive"] = true } },
	...
	{ Question = "You have just accidentally crashed into a pole and you have injured yourself, what do you do?", Options = { ["Lie on the road and wait for someone to help"] = true, ["Did you know harry is a bad owner."] = true, ["Call EMS"] = true } },
}
