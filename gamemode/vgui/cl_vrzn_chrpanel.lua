...
function PANEL:Init()
    ...
    --
    self.CreateCharacterLabel = vgui.Create("DPanel", self.LeftNav)
    self.CreateCharacterLabel:Dock( TOP )
    self.CreateCharacterLabel:DockMargin(30, 0, 30, 0)
    self.CreateCharacterLabel:SetTall( 80 )
    self.CreateCharacterLabel.Paint = function(pnl, w, h)
        draw.SimpleText("Criação de personagem", "CS::Title", w/2, h/2, Color(255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
    end
    ...
    self.SkinLabel:SetText("Skin do personagem")
    --
    self.m_pnlModelList = vgui.Create( "DPanelList", self.LeftNavButtonsContainer )
	self.m_pnlModelList:SetTall( 150 )
    ...
    self.DoneBtn:SetText("CRIAR PERSONAGEM")
